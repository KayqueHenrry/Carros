    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex">
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <p className="font-lexend mb-7 text-offwhite">Passeie nos melhores carros sem os p mb-7reços exorbitantes. Desfrute do conforto aprimorado de um aluguel de luxo e chegue com estilo.</p>

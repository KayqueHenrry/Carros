    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex max-w-[920px]">
        ...
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <p className="font-lexend mb-7 lg:mb-20 text-offwhite">Escolha um sedan pelo seu preço acessível e excelente economia de combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
          <a href="https://www.webmotors.com.br/sedans" className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg"  target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
          ...
          <p className="font-lexend mb-7 lg:mb-20 text-offwhite">Passeie nos melhores carros sem os preços exorbitantes. Desfrute do conforto aprimorado de um aluguel de luxo e chegue com estilo.</p>
